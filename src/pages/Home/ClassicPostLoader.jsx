...
const ClassicPostLoader = props => {
  return (
    <ContentLoader viewBox="0 0 800 400" height={500} width={1200} {...props}>
      ...
      <rect x="69.36" y="0.5" width="160" height="16.48" rx="4.5" />
      <rect x="0.53" y="328.35" width="160" height="16.48" rx="4.5" />
      <rect x="95.84" y="328.35" width="160" height="16.48" rx="4.5" />
      <rect x="195.38" y="328.35" width="304.45" height="16.48" rx="4.5" />
      <rect x="412.47" y="358.52" width="160" height="16.48" rx="4.5" />
